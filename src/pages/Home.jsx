...
import Video from '../../src/assets/hehe.mp4'
  ...
  return (
    <div>
      ...
      <div>
        ...
        heading={
          <div className='text-4xl font-semibold'>Unlock Your <HighlightText text ={"Coding Potential "} />with our Online Course</div>
        }
      ...
      <div>
        ...
        heading={
          <div className='w-[100%] text-4xl font-semibold lg:w-[50%]'>Unlock Your <HighlightText text ={"Coding Potential "} />with our Online Course</div>
        }
        subheading={"Our courses are designed and taught by industry experts who have years of experience in coding and are passionate about sharing their knowledge with you."}
        ctabtn1={{
          text:"Try it yourself",
